...
Punto 2 Realizar un programa que muestre un menú con opciones de colores primario
...
print ("Elije un color de la siguiente lista de colores")
print ("1. amarillo")
print ("2. azul")
print ("3. rojo")
print ("4. blanco")
...
print ("Elije un color para combinarlo con el primer color elegido de la siguiente lista de colores")
print ("1. amarillo")
print ("2. azul")
print ("3. rojo")
print ("4. blanco")
...
if color1==1 and color2==1 :
    ...
    print ("Opcion invalida elige un numero del 1 al 5 ")
